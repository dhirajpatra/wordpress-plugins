...
class ABS_Login_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            'abs_login_widget',
            __('Booking Login', 'advanced-hotel-room-booking'),
            array(
                'description' => __('Login form for booking system users', 'advanced-hotel-room-booking'),
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $title = ! empty($instance['title']) ? $instance['title'] : __('Login', 'advanced-hotel-room-booking');
        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Widget arguments are trusted
        ...
        <div class="abs-login-widget">
            <form name="loginform" id="abs-loginform" action="<?php echo esc_url(wp_login_url($redirect)); ?>" method="post">
                <div class="abs-form-group">
                    <label for="abs-user-login"><?php esc_html_e('Username or Email', 'advanced-hotel-room-booking'); ?></label>
                    <input type="text" name="log" id="abs-user-login" class="input" required>
                </div>
                <div class="abs-form-group">
                    <label for="abs-user-pass"><?php esc_html_e('Password', 'advanced-hotel-room-booking'); ?></label>
                ...
                <div class="abs-form-group">
                    <label>
                        ...
                        <?php esc_html_e('Remember Me', 'advanced-hotel-room-booking'); ?>
                    </label>
                </div>
                <input type="hidden" name="redirect_to" value="<?php echo esc_attr($redirect); ?>">
                <button type="submit" name="wp-submit" id="abs-wp-submit" class="abs-btn abs-btn-primary">
                    <?php esc_html_e('Log In', 'advanced-hotel-room-booking'); ?>
                </button>
            </form>
            ...
            <?php if (get_option('users_can_register')) : ?>
                <div class="abs-register-link">
                    <a href="<?php echo esc_url(wp_registration_url()); ?>">
                        <?php esc_html_e('Register', 'advanced-hotel-room-booking'); ?>
                    </a>
                    |
                    <a href="<?php echo esc_url(wp_lostpassword_url()); ?>">
                        <?php esc_html_e('Lost your password?', 'advanced-hotel-room-booking'); ?>
                    </a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="abs-login-widget">
            <p>
                ...
                printf(
                    ...
                    esc_html__('Welcome, %s!', 'advanced-hotel-room-booking'),
            ...
            <p>
                <a href="<?php echo esc_url($dashboard_url); ?>" class="abs-btn abs-btn-primary">
                    <?php esc_html_e('My Bookings', 'advanced-hotel-room-booking'); ?>
                </a>
            </p>
            <p>
                <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>">
                    <?php esc_html_e('Logout', 'advanced-hotel-room-booking'); ?>
                </a>
            </p>
        </div>
    <?php
    ...
    ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                <?php esc_html_e('Title:', 'advanced-hotel-room-booking'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('redirect')); ?>">
                <?php esc_html_e('Redirect URL after login:', 'advanced-hotel-room-booking'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('dashboard_url')); ?>">
                <?php esc_html_e('Dashboard URL:', 'advanced-hotel-room-booking'); ?>
            </label>
            ...
            <small><?php esc_html_e('URL to display for logged-in users', 'advanced-hotel-room-booking'); ?></small>
        </p>
<?php
    }
