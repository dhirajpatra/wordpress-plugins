 ...
 * Requires PHP: 8.0
 * Author: Dhiraj Patra
 * Author URI: https://github.com/dhirapatra
...
define('UCP_ADAPTER_VERSION', '1.0.0');
...
class UCP_Adapter
{
	...
	private function init_hooks()
	{
		...
		add_action('rest_api_init', array('UCP_REST_API', 'register_routes'));
		add_action('wp_enqueue_scripts', array($this, 'enqueue_scripts'));

		// Admin hooks.
		if (is_admin()) {
			UCP_Admin::get_instance();
		}
	...
	public function init()
	{
		...
		UCP_Session_Handler::get_instance();
	...
	public function deactivate()
	{
		...
		UCP_Session_Handler::cleanup_expired_sessions();
 ...
 */
function ucp_adapter()
{
	return UCP_Adapter::get_instance();
}
