...
1. Upload the plugin files to the `/wp-content/plugins/intelligent-room-booking-system-for-hotel` directory, or install the plugin through the WordPress plugins screen directly.
...
6. Add the booking calendar to any page using the shortcode `[irbsfh_booking_calendar]`.

= Shortcodes =

* `[irbsfh_booking_calendar]` - Display the booking calendar
* `[irbsfh_booking_form]` - Display the booking form
* `[irbsfh_room_list]` - Display list of available rooms
* `[irbsfh_user_bookings]` - Display user's booking history (requires login)
* `[irbsfh_login_widget]` - Display login form
