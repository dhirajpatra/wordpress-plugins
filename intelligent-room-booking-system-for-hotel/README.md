...
├── readme.txt ✓
├── includes/
│   ├── class-irbsfh-database.php ✓
│   ├── class-irbsfh-booking.php ✓
│   ├── class-irbsfh-room.php ✓
│   ├── class-irbsfh-email.php ✓
│   ├── class-irbsfh-settings.php ✓
│   ├── class-irbsfh-validation.php ✓
│   └── class-irbsfh-widget.php ✓
├── admin/
│   ├── class-irbsfh-admin.php ✓
│   └── views/
│       ├── bookings.php ✓
│       ├── rooms.php ✓
│       └── settings.php ✓
├── public/
│   └── class-irbsfh-public.php ✓
└── assets/
    ├── css/
    │   ├── irbsfh-admin.css ✓
    │   └── irbsfh-public.css ✓
